  ...
  <div class="user-agreement">
    ...
    <n-scrollbar class="scrollbar">
      ...
      <n-alert type="warning" title="重要声明">
        PocketTune 是一款完全免费且开源的音乐播放软件，遵循 AGPL-3.0 开源协议发布。
        本软件永远不会向用户收取任何费用。如果您是从第三方渠道付费购买本软件，
        您可能遇到了诈骗，请立即停止使用并举报。
      </n-alert>
      <n-p>
        欢迎使用 PocketTune（以下简称"本软件"）。本软件是一个本地音乐播放软件，可能会调用第三方 API
        来增强其功能。请在使用本软件前仔细阅读本用户协议。本协议是您（以下简称"用户"）与 PocketTune
      ...
      <n-ol>
        ...
        <n-li>用户在使用、修改和分发 PocketTune 时，必须遵守 AGPL-3.0 许可的条款和条件。</n-li>
        <n-li>
